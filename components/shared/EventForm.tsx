    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <div className="flex items-center">
                       ...
                       <Checkbox onCheckedChange={field.onChange} checked={field.value} id="isFree" className="mr-2 h-5 w-5 border-2 border-[#DA9100]" />
        ...
        <Button 
            ...
            className="button col-span-2 w-full bg-[#DA9100]"    
